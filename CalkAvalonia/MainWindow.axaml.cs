...
namespace CalkAvalonia
{
    public partial class MainWindow : Window
    {
        ...
        private void PiButton2_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)// лишяя кнопка 
        {
           ;
        }
        ...
        private void SquareButton_Click1(object? sender, Avalonia.Interactivity.RoutedEventArgs e)// Вычесление корня 
        {
            double number1 = Convert.ToDouble(TextBox.Text);
            double number2 = 10;
            double number = Convert.ToDouble(Math.Pow(number2, number1));
